...
import { type Checkout } from "@/data/platformMockData";
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-[1400px]">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-[#888] mt-1">Gerencie seus {checkouts.length} checkouts de pagamento.</p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={6} className="px-5 py-8 text-center text-[#888]">
                    Nenhum checkout encontrado no banco de dados.
                  </td>
                </tr>
              ) : (
                checkouts.map((ck, i) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-white">{ck.totalSales || 0}</td>
                    <td className="px-5 py-3.5">
